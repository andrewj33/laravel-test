...
var render = function () {
  ...
  return _c(
    "div",
    { staticClass: "container w-4/12 mx-auto space-y-6" },
    _vm._l(_vm.posts, function (post) {
      return _c("div", { key: post.id, staticClass: "rounded shadow-md p-2" }, [
        _c("div", { staticClass: "text-md" }, [
          _c("strong", [_vm._v(_vm._s(post.name))]),
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "flex flex-row" }, [
          _c("div", { staticClass: "text-sm align-bottom" }, [
            _vm._v(
              "Created " +
